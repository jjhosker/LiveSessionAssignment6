...
## 2. Sales Price vs. Gross Square Feet AND Sales Price vs. Land Square Feet For All Family Dwellings
  ...
  • We use the entire data set and then filter out the outliers > $10 mill in sales price to get a more accurate intrepretation of the distribution.  This removes only four samples.
...
## Analysis:  We can generally see that the sales prices increases as the gross square footage increases.
